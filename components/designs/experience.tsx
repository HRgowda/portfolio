                     ...
                     <ul className="list-disc pl-5 space-y-2 text-white/80">
                       {section.bullets.map((bullet, bulletIndex) => (
                         <li key={`${exp.companyName}-bullet-${sectionIndex}-${bulletIndex}`}>
                           {bullet.split(/(React|Next\.js|Tailwind CSS|shadcn\/ui|FastAPI|PostHog|Python|Object-Oriented Programming|OOP|SQL|Database Management System|MySQL|pair programming|Hono|Node\.js|Wrangler|Cloudflare Workers|Neon|Prisma|Prisma Accelerate|Cloudflare Pages|Cloudflare R2|Astro|Vite|Channel Partner|Sales Agent|role-based authentication|Slack|document processor|Eligibility module|image optimization|Lighthouse|robots\.txt|sitemap\.xml|lead tracking|real-time monitoring|loan applications|onboarding flow|document uploads|validation|dashboard|loan journeys|Zoho CRM|automation|leads|customer metadata|sales team)/g).map((part, partIndex) => {
                             const isKeyword = /^(React|Next\.js|Tailwind CSS|shadcn\/ui|FastAPI|PostHog|Python|Object-Oriented Programming|OOP|SQL|Database Management System|MySQL|pair programming|Hono|Node\.js|Wrangler|Cloudflare Workers|Neon|Prisma|Prisma Accelerate|Cloudflare Pages|Cloudflare R2|Astro|Vite|Channel Partner|Sales Agent|role-based authentication|Slack|document processor|Eligibility module|image optimization|Lighthouse|robots\.txt|sitemap\.xml|lead tracking|real-time monitoring|loan applications|onboarding flow|document uploads|validation|dashboard|loan journeys|Zoho CRM|automation|leads|customer metadata|sales team)$/.test(part);
                             return isKeyword ? (
