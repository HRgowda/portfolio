      ...
      <section id="education" className="py-8 px-4 md:px-8 relative overflow-hidden">
        ...
        >
          ...
          {educationData.map((education, index) => (
            <Card
              key={index}
              className="p-8 backdrop-blur-sm bg-white/5 rounded-xl border-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-md hover:shadow-white mb-8"
            >
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                ...
                <div className="mt-4 md:mt-0 flex flex-col items-center md:items-center">
                  {/* Grade - Centered */}
                  <span className="text-lg text-white text-center">{education.grade}</span>
                  {/* Duration - Below Grade */}
                  <span className="mt-2 inline-flex items-center px-4 py-2 rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors duration-300">
                    {education.duration}
                  </span>
                </div>
              </div>
